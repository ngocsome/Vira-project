...
public class AttachmentController {
    ...
    @PostMapping(consumes = MediaType.MULTIPART_FORM_DATA_VALUE) public ApiResponse<AttachmentResponse> upload(@PathVariable Long projectId, @PathVariable Long taskId, @RequestPart("file") MultipartFile file) { return ApiResponse.ok(attachmentService.upload(projectId, taskId, file), "Tải tệp lên thành công"); }
